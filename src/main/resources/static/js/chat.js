...
async function loadListUserChat(){
    ...
    var urlAccount = 'http://'+urlFirst+'/api/user/getAllUserChat';
    ...
    var stt = false;
    if(id != null){
        var url = 'http://'+urlFirst+'/api/public/findUserNotDtoById?id='+id;
...
async function loadMessageChat(idnguoinhan){
    ...
    var token = localStorage.getItem("token");
    var username = localStorage.getItem("username");
    var urlAccount = 'http://'+urlFirst+'/api/user/getListChat?idnguoinhan='+idnguoinhan;
    const res = await fetch(urlAccount, {
        method: 'GET',
        headers: new Headers({
            'Authorization': 'Bearer ' + token
